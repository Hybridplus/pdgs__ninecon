...
@section('form')
    <form class="form-rtl">
        ...
        <div class="form-group row">
            <label for="fullName" class="col-12 col-md-3 col-lg-2 col-form-label text-danger">* שם מלא:</label>
        ...
        <div class="form-group row">
            <label for="email" class="col-12 col-md-3 col-lg-2 col-form-label text-danger">* דואר אלקטרוני:</label>
            <div class="col-12 col-md-9 col-lg-10">
        ...
        <div class="form-group row">
            <label for="brand" class="col-12 col-md-3 col-lg-2 col-form-label text-danger">* משפחה:</label>
            <div class="col-12 col-md-9 col-lg-10">
        ...
        <div class="form-group row">
            <label for="product" class="col-12 col-md-3 col-lg-2 col-form-label text-danger">* מוצר:</label>
            <div class="col-12 col-md-9 col-lg-10">
        ...
        <div class="form-group row">
            <label for="date" class="col-12 col-md-3 col-lg-2 col-form-label text-danger">* תאריך רכישה:</label>
            <div class="col-12 col-md-9 col-lg-10">
                <input type="date" class="form-control" id="date" v-model="date" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="place" class="col-12 col-md-3 col-lg-2 col-form-label text-danger">* מקום רכישה:</label>
            <div class="col-12 col-md-9 col-lg-10">
        ...
        <div class="form-group row">
            <label for="freetext" class="col-12 col-md-3 col-lg-2 col-form-label text-danger">* הסבר על התקלה:</label>
            <div class="col-12 col-md-9 col-lg-10">
                <textarea class="form-control" id="freetext" v-model="freetext" required></textarea>
            </div>
        </div>
        <div class="form-group row">
            <label for="hours" class="col-12 col-md-3 col-lg-2 col-form-label text-danger">* מקום רכישה:</label>
            <div class="col-12 col-md-9 col-lg-10">
                <input type="text" class="form-control" id="hours" v-model="hours" required>
            </div>
        </div>
